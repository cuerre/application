...
class EncodingController extends Controller
{
    ...
    public static function EncodeString( Request $request )
    {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'dotsize'       => 'bail|integer|between:1,5',
            'ecc'           => ['bail', 'regex:/[L|M|Q|H]{1}/'],
            'marginsize'    => 'bail|integer|between:1,5',
            'dpi'           => 'bail|integer|between:50,100',
            'output'        => ['bail','regex:/[PNG|EPS|SVG]{1}/'],
        ]);
